...
function Weather() {
  ...
  const { weather } = useSelector((state) => state.user);
  return (
    <div
    ...
    >
      ...
      >
        <ul style={{ display: "flex" }}>
          {weather.slice(0, 2).map((weather, i) => (
            <li className="list-item" key={i}>
              <div className="cardm">
                <div className="card">
                  ...
                  <div className="main">{weather.temperatureC} °C</div>
                  <div className="mainsub">{weather.summary}</div>
